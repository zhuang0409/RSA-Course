...
% A1_RSA_searchlight.m: fMRI searchlights with representational similarity analysis
% The data used here is available from http://cosmomvpa.org/datadb.zip

%% Set data paths
ak6_study_path = '/Users/zuzakabulska/Documents/CoSMoMVPA_datadb/tutorial_data/ak6/';
...
% save results
output_fn=fullfile(ak6_study_path,'rsm.nii');
cosmo_map2fmri(ds_rsm,output_fn);

%% execrise for you
% (1) change the target_dsm (your data/ behavioral data) at least 3 subjects' results
% (2) how to run whole-brain searchlight rsa with behavioral models and v1 dsm models 